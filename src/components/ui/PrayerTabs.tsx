    ...
    <div className="flex w-full max-w-[280px] rounded-full bg-bg-secondary p-1">
      <button
        ...
        className={`relative flex-1 py-2 text-xs font-medium uppercase tracking-wider transition-colors ${
          activeTab === "timer" ? "text-accent" : "text-text-secondary"
        }`}
      >
        {activeTab === "timer" && (
          <motion.div
            layoutId="activeTab"
            className="absolute inset-0 rounded-full border border-accent/40 bg-accent/10 shadow-sm"
      ...
      <button
        ...
        className={`relative flex-1 py-2 text-xs font-medium uppercase tracking-wider transition-colors ${
          activeTab === "prayers" ? "text-accent" : "text-text-secondary"
        }`}
      >
        {activeTab === "prayers" && (
          <motion.div
