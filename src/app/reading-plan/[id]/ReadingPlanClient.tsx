  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        // En static export Capacitor, l'id réel est passé en query param (?id=uuid)
        // car les chemins dynamiques non pré-générés n'ont pas de fichier HTML statique
        const planId = (searchParams.get("id") || params.id) as string;
